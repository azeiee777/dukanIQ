<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-semibold text-ink-900 dark:text-white tracking-tight">Verify Your Email</h2>
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full sm:w-auto">
            ...
            <button type="submit"
                class="w-full sm:w-auto text-center text-sm font-semibold text-ink-500 dark:text-ink-400 hover:text-ink-800 dark:hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 transition-colors">
                {{ __('Log Out') }}
            </button>
        </form>
    </div>
