<x-guest-layout>
    <div class="text-center mb-8">
        ...
        <h2 class="text-2xl font-semibold text-stone-900 dark:text-white tracking-tight">Create Account</h2>
        <p class="text-stone-500 dark:text-stone-400 text-sm mt-2">Join thousands of smart shopkeepers - Email verification required</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            <label for="name"
                class="block text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wide mb-1.5 ml-1">Shop
                Owner Name</label>
        ...
        <div x-data="{ show: false }">
            <label for="password"
                class="block text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wide mb-1.5 ml-1">Password</label>
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-stone-400 group-focus-within:text-primary-500 transition-colors duration-200"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div x-data="{ show: false }">
            <label for="password_confirmation"
                class="block text-xs font-semibold text-stone-500 dark:text-stone-400 uppercase tracking-wide mb-1.5 ml-1">Confirm
                Password</label>
            <div class="relative group">
                <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-stone-400 group-focus-within:text-primary-500 transition-colors duration-200"
